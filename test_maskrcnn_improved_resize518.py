...
from train_maskrcnn_improved_resize518 import collate_fn_maskrcnn, compute_metrics
...
def test_model(
    ...
    from dinov2_maskrcnn_improved_resize518 import create_improved_maskrcnn
